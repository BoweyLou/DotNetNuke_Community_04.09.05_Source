...
<table cellspacing="0" cellpadding="4" border="0" summary="Module Controls Design Table">
	...
	<tr>
		<td class="SubHead" width="150" valign="top"><dnn:label id="plSource" text="Source:" controlname="cboSource" runat="server" /></td>
		<td>
		    <asp:dropdownlist id="cboSource" runat="server" width="390" cssclass="NormalTextBox" autopostback="True"></asp:dropdownlist><br />
	...
	<tr>
		<td class="SubHead" width="150"><dnn:label id="plSupportsPartialRendering" text="Supports Partial Rendering?" controlname="chkSupportsPartialRendering" runat="server" /></td>
		<td><asp:checkbox id="chkSupportsPartialRendering" runat="server" cssclass="NormalTextBox"></asp:checkbox></td>
	</tr>
</table>
<p>
