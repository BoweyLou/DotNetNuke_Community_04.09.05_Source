        ...
        <td>
            ...
            <div id="divInstalled" runat="server">
                ...
                <table>
                    <tr>
                        <td valign="top">
                            <dnn:Label ID="lblLocales" runat="server" Text="Locales:" ControlName="cboLocales" Suffix=":"></dnn:Label>
                        </td>
                        <td valign="top">
                            <asp:DropDownList ID="cboLocales" Width="200px" runat="server" AutoPostBack="True" DataValueField="key" DataTextField="name" CssClass="Normal"></asp:DropDownList>
                        </td>
                    </tr>
                </table>
                </center>
                ...
                <asp:DataGrid ID="grdDefinitions" BorderWidth="0" BorderStyle="None" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Upgrade">
                            ...
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblUpgrade" runat="server" Text='<%# UpgradeService(DataBinder.Eval(Container.DataItem,"Version"),DataBinder.Eval(Container.DataItem,"ModuleName")) %>' ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
                </asp:DataGrid>
