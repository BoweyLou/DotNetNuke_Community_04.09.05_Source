...
<center>
	<table cellSpacing="0" cellPadding="0" width="500" border="0">
		...
		<tr>
			<td align="center" colSpan="4"><asp:linkbutton id="cmdRestore" CssClass="CommandButton" Runat="server" resourcekey="cmdRestore">Restore Default Skin</asp:linkbutton></td>
		</tr>
		<tr>
			<td colSpan="4">&nbsp;</td>
		</tr>
		...
		<tr>
			<td class="SubHead" align="center" colSpan="4">
			    <asp:panel id="pnlSkin" Runat="server" Visible="False">
                    ...
                    <asp:LinkButton id="cmdParse" resourcekey="cmdParse" Runat="server" CssClass="CommandButton">Parse Skin Package</asp:LinkButton>&nbsp;&nbsp; 
                    <asp:LinkButton id="cmdDelete" resourcekey="cmdDelete" Runat="server" CssClass="CommandButton">Delete Skin Package</asp:LinkButton>
                </asp:panel>
            </td>
		</tr>
		<tr>
