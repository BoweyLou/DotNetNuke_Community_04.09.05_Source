...
<%@ Register TagPrefix="dnn" Namespace="DotNetNuke.Security.Permissions.Controls"
    Assembly="DotNetNuke" %>
<%@ Control Inherits="DotNetNuke.Modules.Admin.FileSystem.FileManager" Language="vb"
    AutoEventWireup="false" Explicit="True" CodeFile="FileManager.ascx.vb" %>
	...
	<tr>
		<td vAlign="top" width="205" bgColor="#ffffff">
			<table class="FileManager_Explorer" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td class="FileManager_Header" width="100%" valign="middle"><asp:ImageButton ID="lnkSyncFolders" runat="server" ImageUrl="~/images/FileManager/ToolBarSynchronize.gif" ToolTip="Synchronize Folders" />&nbsp;<asp:label id="lblFolders" Runat="server" EnableViewState="False" resourcekey="Folders" Width="100%" CssClass="SubHead">Folders</asp:label></td>
				</tr>
				<tr>
					<td vAlign="top">
					    <span id="pnlFolders" style="width: 200px; height: 300px; background-color: #ffffff" onscroll="fldScroll();" runat="server">
							<asp:panel id="pnlTreeInitScripts" style="overflow:auto; margin-left: 2px; width: 200px; height: 300px;" Runat="server">
								<dnntv:DNNTree id="DNNTree" runat="server" DefaultNodeCssClassSelected="FileManagerTreeNodeSelected" DefaultNodeCssClass="FileManagerTreeNode" DefaultChildNodeCssClass="FileManagerTreeNode" />
							</asp:panel>
						</span>
					</td>
				</tr>
