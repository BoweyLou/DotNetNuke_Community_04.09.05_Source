<%@ Control Language="vb" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.Modules.Admin.FileSystem.WebUpload" CodeFile="WebUpload.ascx.vb" %>
        ...
        <td valign="top">
            <asp:Panel ID="pnlUpload" Visible="True" CssClass="WorkPanel" runat="server">
                ...
                <table id="tblLogs" cellspacing="0" cellpadding="0" summary="Resource Upload Logs Table"
                    ...
                    <tr>
                        <td><asp:Label ID="lblLogTitle" runat="server" resourcekey="LogTitle">Resource Upload Logs</asp:Label></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td><dnn:CommandButton ID="cmdReturn2" runat="server" CssClass="CommandButton" imageurl="~/images/lt.gif" resourcekey="cmdReturn"/></td>
                    </tr>
                </table>
            </asp:Panel>
        </td>
