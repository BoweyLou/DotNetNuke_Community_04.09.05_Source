...
<%@ Register TagPrefix="dnn" TagName="ListEntries" Src="~/Admin/Lists/ListEntries.ascx" %>
        ...
        <asp:WizardStep ID="wizLocalization" runat="server" Title="Localization" AllowReturn="false">
            <table cellpadding="0" cellspacing="0" border="0">
                <tr height="25">
                    ...
                    <td valign="top">
                        <asp:DropDownList ID="cboLocales" runat="server" AutoPostBack="True"
                            Width="200px" DataValueField="key" DataTextField="name" CssClass="NormalTextBox">
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtPropertyName" runat="Server" Width="200px" />
                    </td>
                </tr>
                <tr>
                    <td width="150" class="SubHead" valign="top">
                    ...
                    <td><asp:TextBox ID="txtPropertyHelp" runat="Server" CssClass="NormalTextBox" 
                                Width="200px" Columns="25" Rows="3" TextMode="MultiLine" Wrap="true" />
                    </td>
                </tr>
                <tr>
                    <td width="150" class="SubHead" valign="top">
                    ...
                    <td><asp:TextBox ID="txtCategoryName" runat="Server" Width="200px" />
                    </td>
                </tr>
                <tr>
