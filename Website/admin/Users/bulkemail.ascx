<%@ Control Inherits="DotNetNuke.Modules.Admin.Users.BulkEmail" CodeFile="BulkEmail.ascx.vb" Language="vb" AutoEventWireup="false" Explicit="True" %>
        ...
        <td width="760" valign="top">
            <asp:Panel ID="pnlSettings" runat="server" CssClass="WorkPanel" Visible="True">
                ...
                <div id="divBasic" runat="server">
                    <table id="tblBasic" cellspacing="0" cellpadding="2" width="725" summary="Basic Settings Design Table" border="0">
                        <colgroup><col width="200" /><col width="525" /></colgroup>
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <div id="divAdr" runat="server">
                                    <table width = "100%">
                                        <colgroup><col width="200" /><col width="525" /></colgroup>
                                        <tr>
                                            <td class="SubHead" valign="top"><dnn:Label ID="plRoles" runat="server" ControlName="chkRoles" cssclass="SubHead" Suffix=":"/></td>
                                            <td align="left"><dnn:RolesSelectionGrid runat="server" ID="dgSelectedRoles" /></td>
                                        </tr>
                                        <tr valign="top">
                                            <td class="SubHead"><dnn:Label id="plLanguages" runat="server" ControlName="selLanguage" CssClass="SubHead" Suffix=":" /></td>
                                            <td><dnn:LanguageSelector runat="server" ID="selLanguage" SelectionMode="Multiple" ListDirection="Vertical" ItemStyle="FlagAndCaption" /></td>
                                        </tr>
                                        <tr valign="top">
                                            <td class="SubHead"><dnn:label id="plEmail" runat="server" controlname="txtEmail" suffix=":" /></td>
                                            <td><asp:TextBox ID="txtEmail" CssClass="NormalTextBox" runat="server" Width="100%" TextMode="MultiLine" rows="3" /></td>
                                        </tr>
                                    </table>
                                </div>
                            </td>
                        ...
                        <tr valign="top">
                            <td class="SubHead"><dnn:label id="plFrom" runat="server" controlname="txtFrom" suffix=":" /></td>
                            <td>
                                <asp:TextBox ID="txtFrom" CssClass="NormalTextBox" runat="server" Width="100%" Columns="40" MaxLength="100" />
                        ...
                        <tr valign="top">
                            <td class="SubHead"><dnn:label id="plReplyTo" runat="server" controlname="txtReplyTo" suffix=":" /></td>
                            <td>
                                <asp:TextBox ID="txtReplyTo" CssClass="NormalTextBox" runat="server" Width="100%" Columns="40" MaxLength="100" />
                        ...
                        <tr valign="top">
                            <td class="SubHead"><dnn:Label ID="plSubject" runat="server" ControlName="txtSubject" Suffix=":" /></td>
                            <td><asp:TextBox ID="txtSubject" CssClass="NormalTextBox" runat="server" Width="100%" Columns="40" MaxLength="100" /></td>
                        </tr>
                    </table>
                </div> 
                <br />
                ...
                <table id="tblAdvanced" cellspacing="0" cellpadding="2" width="525" summary="Message Design Table"
				    ...
				    <tr valign="top">
				        <td class="SubHead" width="150">
						    <dnn:label id="plNoDuplicates" runat="server" controlname="chkNoDuplicates" suffix=":" /></td>
					    <td width="325">
						    <asp:CheckBox id="chkNoDuplicates" cssclass="Normal" runat="server" Checked="false" /></td>
				    </tr>
                    <tr valign="top">
                        <td class="SubHead" width="150">
