				...
				<tr>
					...
					<td valign="top" width="475">
						...
						<table id="tblDetails" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" width="150"><dnn:label id="plFriendlyName" text="Module:" runat="server" controlname="lblFriendlyName"></dnn:label></td>
								<td><asp:TextBox ID="txtFriendlyName" runat="server" CssClass="NormalTextBox" Width="250" Enabled="False"></asp:TextBox></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="SubHead" width="150" valign="top" colspan="2"><br>
									...
									<table border="0" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td><asp:checkbox id="chkInheritPermissions" cssclass="Normal" autopostback="true" runat="server"
													text="Inherit <b>View</b> permissions from <b>Page</b>" resourcekey="InheritPermissions" /></td>
										</tr>
									</table>
								</td>
							</tr>
					...
					<td valign="top" width="475">
						...
						<table id="tblAppearance" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							...
							<tr>
								...
								<td valign="top">
									<asp:radiobuttonlist id="cboAlign" cssclass="NormalTextBox" runat="server" repeatdirection="Horizontal">
										...
										<asp:listitem resourcekey="Not_Specified" value="">Not Specified</asp:listitem>
									</asp:radiobuttonlist>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top">
									<asp:textbox id="txtBorder" width="250" cssclass="NormalTextBox" runat="server" MaxLength="1"></asp:textbox>
			...
			<table id="tblSpecific" cellspacing="0" cellpadding="2" width="525" summary="Specific Settings Design Table"
				...
				<TR id="rowspecifichelp" runat="server">
					<TD colSpan="2" class="NormalBold" align="left">
						...
						<asp:label id="lblSpecificSettingsHelp" cssclass="Normal" runat="server" resourcekey="SpecificSettingsHelp"
							enableviewstate="False">In this section, you can set up settings that are specific for this module.</asp:label><br /><br /></TD>
				</TR>
				<tr>
					<td width="25"></td>
					<td valign="top" width="475">
...
<p>
	...
	<asp:linkbutton class="CommandButton" id="cmdCancel" resourcekey="cmdCancel" runat="server" text="Cancel" causesvalidation="False"></asp:linkbutton>&nbsp;&nbsp;
	<asp:linkbutton class="CommandButton" id="cmdDelete" resourcekey="cmdDelete" runat="server" text="Delete" causesvalidation="False"></asp:linkbutton>
</p>
