...
<%@ Control language="vb" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.Modules.Admin.PortalManagement.Signup" CodeFile="Signup.ascx.vb" %>
		...
		<td vAlign="top" width="560"><dnn:sectionhead id="dshPortal" includerule="True" resourcekey="PortalSetup" section="tblPortal"
			...
			<table id="tblPortal" cellSpacing="0" cellPadding="2" width="525" summary="Basic Settings Design Table"
				...
				<tr id="rowType" runat="server">
					...
					<td class="SubHead"><asp:radiobuttonlist id="optType" cssclass="Normal" runat="server" repeatdirection="Horizontal" AutoPostBack="True">
				...
				<tr>
					...
					<td class="NormalTextBox" width="325" nowrap>
						<asp:textbox id="txtHomeDirectory" cssclass="NormalTextBox" runat="server" width="300" maxlength="100"></asp:textbox>&nbsp;<asp:LinkButton CausesValidation="False" ID="btnCustomizeHomeDir" Runat="server" resourcekey="Customize"
							CssClass="CommandButton">Customize</asp:LinkButton></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td vAlign="top"><asp:dropdownlist id="cboTemplate" cssclass="NormalTextBox" runat="server" width="300" AutoPostBack="True"></asp:dropdownlist>
...
<p><dnn:commandButton class="CommandButton" id="cmdUpdate" ImageUrl="~/images/save.gif" resourcekey="cmdUpdate" runat="server" />&nbsp;&nbsp;
	<dnn:commandButton class="CommandButton" id="cmdCancel" ImageUrl="~/images/lt.gif" resourcekey="cmdCancel" runat="server" causesvalidation="False"/></p>
