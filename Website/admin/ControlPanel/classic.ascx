...
<table width="100%" border="0" summary="Table for design" id="Table2" style="BORDER-RIGHT:#cccccc 1px dotted; BORDER-TOP:#cccccc 1px dotted; BORDER-LEFT:#cccccc 1px dotted; BORDER-BOTTOM:#cccccc 1px dotted">
    <tr valign="top">
        <td align="left" valign="bottom" width="20%" nowrap>
            <table border="0" id="tblIconBarTab" runat="server">
                <tr>
                    <td nowrap>
        ...
        <td align="center" valign="top" nowrap cssClass="SubHead">
			<table cellspacing="1" cellpadding="0" border="0" height="100%" id="tblIconBarModule" runat="server">
				<tr valign="middle">
				    <td>
                        <asp:imagebutton id="cmdHelpShow" imageurl="~/images/help.gif" alternatetext="Show Module Info" runat="server" visible="False" borderwidth="0" enableviewstate="False"></asp:imagebutton>
                        <asp:imagebutton id="cmdHelpHide" imageurl="~/images/cancel.gif" alternatetext="Hide Module Info" runat="server" visible="False" borderwidth="0" enableviewstate="False"></asp:imagebutton>
				    </td>
				    <td>&nbsp;</td>
