				...
				<tr>
					...
					<td valign="top" width="475">
						...
						<table id="tblConfiguration" cellspacing="2" cellpadding="2" summary="Configuration Design Table" border="0" runat="server">
							...
							<tr>
								<td class="SubHead" width="150"><dnn:label id="plServerTime" text="Server Time:" controlname="lblServerTime" runat="server" /></td>
								<td><asp:Label ID="lblServerTime" Runat="server" CssClass="NormalBold" /></td>
							</tr>
							<tr>
								<td class="SubHead" width="150"><dnn:label id="plWebFarm" text="Web Farm Enabled?" controlname="lblWebFarm" runat="server" /></td>
								<td><asp:Label ID="lblWebFarm" Runat="server" CssClass="NormalBold" /></td>
							</tr>
							<tr>
				...
				<tr>
					...
					<td valign="top" width="475">
						...
						<table id="tblOther" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" width="150"><dnn:label id="plAJAX"  controlname="chkAJAX" runat="server" /></td>
								<td><asp:checkbox id="chkAJAX" cssclass="NormalTextBox" runat="server" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="SubHead" width="150"><dnn:label id="plLogBuffer" text="Enable Event Log Buffer?" controlname="chkLogBuffer" runat="server" /></td>
