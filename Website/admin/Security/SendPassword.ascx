...
<div style="text-align:left;">
    <asp:Label ID="lblHelp" runat="Server" class="normal" resourcekey="SendPasswordHelp" />
</div>
<br /><table cellspacing="0" cellpadding="3" border="0" summary="SignIn Design Table" width="160">
	<tr>
