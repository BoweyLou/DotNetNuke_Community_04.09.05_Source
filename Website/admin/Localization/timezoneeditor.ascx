<%@ Control Language="vb" AutoEventWireup="false" Inherits="DotNetNuke.Services.Localization.TimeZoneEditor" CodeFile="TimeZoneEditor.ascx.vb" %>
			...
			<asp:TemplateColumn HeaderText="DefaultValue">
				<ItemTemplate>
					<asp:Label id="Label2" runat="server" CssClass="Normal">
						<%# Container.DataItem.Row.GetParentRow("defaultvalues").Item("defaultvalue") %>
					</asp:Label>
				</ItemTemplate>
			</asp:TemplateColumn>
		</Columns>
