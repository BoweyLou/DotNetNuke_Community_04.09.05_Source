        ...
        <asp:Wizard ID="wizInstall" runat="server" CssClass="Wizard" ActiveStepIndex="0" 
            ...
            <StepNavigationTemplate>
                <table border="0" cellpadding="5" cellspacing="5">
                    <tr>
                        <td align="right">
                            <asp:LinkButton ID="CustomButton" runat="server" Text="Custom" CssClass="WizardButton" Visible = "False" />
                        </td>
                        <td align="right">
                            <asp:LinkButton ID="StepPreviousButton" runat="server" CommandName="MovePrevious" Text="Previous" CssClass="WizardButton" />
                        </td>
                        <td align="right">
                            <asp:LinkButton ID="StepNextButton" runat="server" CommandName="MoveNext" Text="Next" CssClass="WizardButton" />
                         </td>
                    </tr>
                </table>
            </StepNavigationTemplate>
            ...
            <WizardSteps>
                <asp:WizardStep ID="Step0" runat="Server" Title="Welcome">
                    ...
                    <table id="tblLanguage" runat="server" cellpadding="0" cellspacing="0" border="0">
                         <tr>
                            <td class="NormalBold" width="200" valign="top"><asp:Label ID="lblChooseInstall" runat="server" /></td>
                            <td class="Normal" width="450"><asp:RadioButtonList ID="rblInstall" runat="Server" RepeatDirection="Vertical" /></td>
                        </tr>
                         <tr>
                            <td class="NormalBold" width="200" valign="top"><asp:Label ID="lblChooseLanguage" runat="server" /></td>
                            <td class="Normal" width="450"><asp:DropDownList ID="cboLanguages" AutoPostBack="true" runat="Server" DataTextField="Text" DataValueField="Code" /></td>
                        </tr>
                    </table>
                ...
                <asp:WizardStep ID="Step1" runat="server" Title="FilePermissions">
                    ...
                    <asp:CheckBoxList ID="lstPermissions" runat="server" DataTextField="Name" DataValueField="Permission" TextAlign="Left" />
                    <hr />
                ...
                <asp:WizardStep ID="Step2" runat="server" Title="ConnectionString" AllowReturn="false">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="NormalBold" style="width:150px;"><asp:Label ID="lblChooseDatabase" runat="server" /></td>
                            <td class="Normal" width="550">
                                <asp:RadioButtonList ID="rblDatabases" runat="Server" AutoPostBack="true" RepeatDirection="Horizontal" RepeatColumns="3"/>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <table id="tblDatabase" runat="Server" visible="False" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblServer" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:TextBox ID="txtServer" runat="Server" Width="150px"/></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblServerHelp" runat="Server" /></td>
                        </tr>
                        <tr id="trFile" runat="server">
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblFile" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:TextBox ID="txtFile" runat="Server" Width="150px"/></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblDatabaseFileHelp" runat="Server" /></td>
                        </tr>
                        <tr id="trDatabase" runat="server">
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblDataBase" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:TextBox ID="txtDatabase" runat="Server" Width="150px"/></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblDatabaseHelp" runat="Server" /></td>
                        </tr>
                        <tr id="trIntegrated" runat="server">
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblIntegrated" runat="Server" /></td>
                            <td valign="top"><asp:CheckBox ID="chkIntegrated" runat="Server" AutoPostBack="True"/></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblIntegratedHelp" runat="Server" /></td>
                        </tr>
                        <tr id="trUser" runat="Server">
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblUserId" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:TextBox ID="txtUserId" runat="Server" Width="150px"/></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblUserHelp" runat="Server" /></td>
                        </tr>
                        <tr id="trPassword" runat="Server">
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblPassword" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:TextBox ID="txtPassword" runat="Server" TextMode="Password" Width="150px"/></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblPasswordHelp" runat="Server" /></td>
                        </tr>
                        <tr>
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblOwner" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:CheckBox ID="chkOwner" runat="Server" /></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblOwnerHelp" runat="Server" /></td>
                        </tr>
                        <tr>
                            <td class="NormalBold" style="width:150px;" height="30" valign="top"><asp:label id="lblQualifier" runat="Server" /></td>
                            <td class="Normal" style="width:150px;" valign="top"><asp:TextBox ID="txtqualifier" runat="Server" Width="150px" /></td>
                            <td class="Help" valign="middle"><asp:Label ID="lblQualifierHelp" runat="Server" /></td>
                        </tr>
                    </table>
                    <hr />
                ...
                <asp:WizardStep ID="Step5" runat="server" Title="Modules">
                ...
                <asp:WizardStep ID="Step6" runat="server" Title="Packages">
                    <h2><asp:Label ID="lblStep6Title" runat="server"/></h2>
                    <asp:Label ID="lblStep6Detail" runat="Server" />
                    <hr />
                    <h3><asp:Label ID="lblPackages" runat="server" /></h3>
                    <asp:CheckBoxList ID="lstPackages" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" />
                    <asp:Label ID="lblNoPackages" runat="server" />
                    <hr />
                    <asp:Label ID="lblPackagesError" runat="server" />
                </asp:WizardStep>
                <asp:WizardStep ID="Step7" runat="server" Title="Skins">
                ...
                <asp:WizardStep ID="Step8" runat="server" Title="Languages">
                ...
                <asp:WizardStep ID="Step9" runat="server" Title="Portal" AllowReturn="false">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
				        <tr>
					        <td class="NormalBold" style="width:150px;"><asp:label id="lblPortalTitle" runat="server" /></td>
					        <td class="Normal"><asp:textbox id="txtPortalTitle" runat="server" style="width:250px;" maxlength="128"></asp:textbox></td>
				        </tr>
				        <tr>
					        <td class="NormalBold" style="width:150px;"><asp:label id="lblPortalTemplate" runat="server" /></td>
					        <td class="Normal"><asp:dropdownlist id="cboPortalTemplate" runat="server" style="width:250px;" /></td>
				        </tr>
                    </table>
                    <hr />
